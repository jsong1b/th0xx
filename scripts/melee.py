...
def grayStickTarget(active_keys, graystick_block_reac, shield_pressed, graystick_prev, graystick_start_time):
    ...
    if MODX_Bind in active_keys:
        if diag:
            if shield_pressed and B_Bind in active_keys: target = [68 * dir[0], 41 * dir[1]] # diag + shield + b
        ...
        if diag:
            ...
            # if B_Bind in active_keys: graystick_target[0] = 80 * dir[0] # turaround neutral B nerf
